...
function insertCapturarImg(){
	...
	document.getElementById("tabla").innerHTML += `
<a href="../coordinacion/${nuevoCapturarImg.capturarImg}" target="_blank" download><img  class="capturarImg" alt="${nuevoCapturarImg.capturarNombre}" title="${nuevoCapturarImg.capturarNombre}" src="../coordinacion/${nuevoCapturarImg.capturarImg}"></a>
	`;
document.getElementById("ventana").innerHTML += `
<a href="../coordinacion/${nuevoCapturarImg.capturarImg}" target="_blank" download><img  class="capturarImg" alt="${nuevoCapturarImg.capturarNombre}" title="${nuevoCapturarImg.capturarNombre}" src="../coordinacion/${nuevoCapturarImg.capturarImg}"></a>
	`;
...
<div class="capturarTextoImg">	
	...
	<a href="../coordinacion/${nuevoCapturarTextoImg.capturarImg1}" target="_blank" download><img alt="${nuevoCapturarTextoImg.capturarNombre1}" title="${nuevoCapturarTextoImg.capturarNombre1}" src="../coordinacion/${nuevoCapturarTextoImg.capturarImg1}"></a>
</div>
	`;
document.getElementById("ventana").innerHTML += `
<div class="capturarTextoImg">	
...
function insertCapturarImgTexto(){
	...
	document.getElementById("tabla").innerHTML += `
<div class="capturarTextoImg">	
	<a href="../coordinacion/${nuevoCapturarImgTexto.capturarImg2}" target="_blank" download><img alt="${nuevoCapturarImgTexto.capturarNombre2}" title="${nuevoCapturarImgTexto.capturarNombre2}" src="../coordinacion/${nuevoCapturarImgTexto.capturarImg2}"></a>
...
function insertCapturarPDF(){
	...
	document.getElementById("tabla").innerHTML += `
<a href="../coordinacion/${nuevocapturarPDF.capturarPDF}" target="_blank" download><img  class="capturarArchivo" src="img/pdf.png"></a>
	`;
document.getElementById("ventana").innerHTML += `
<a href="../coordinacion/${nuevocapturarPDF.capturarPDF}" target="_blank" download><img  class="capturarArchivo" src="img/pdf.png"></a>
	`;
...
function insertCapturarWORD(){
	...
	document.getElementById("tabla").innerHTML += `
<a href="../coordinacion/${nuevocapturarWORD.capturarWORD}" target="_blank" download><img  class="capturarArchivo" src="img/word.png"></a>
	`;
document.getElementById("ventana").innerHTML += `
<a href="../coordinacion/${nuevocapturarWORD.capturarWORD}" target="_blank" download><img  class="capturarArchivo" src="img/word.png"></a>
	`;
...
function insertCapturarEXCEL(){
	...
	document.getElementById("tabla").innerHTML += `
<a href="../coordinacion/${nuevocapturarEXCEL.capturarEXCEL}" target="_blank" download><img  class="capturarArchivo" src="img/excel.png"></a>
	`;
document.getElementById("ventana").innerHTML += `
<a href="../coordinacion/${nuevocapturarEXCEL.capturarEXCEL}" target="_blank" download><img  class="capturarArchivo" src="img/excel.png"></a>
	`;
...
function insertCapturarPP(){
	...
	document.getElementById("tabla").innerHTML += `
<a href="../coordinacion/${nuevocapturarPP.capturarPP}" target="_blank" download><img  class="capturarArchivo" src="img/pp.png"></a>
	`;
document.getElementById("ventana").innerHTML += `
<a href="../coordinacion/${nuevocapturarPP.capturarPP}" target="_blank" download><img  class="capturarArchivo" src="img/pp.png"></a>
	`;
